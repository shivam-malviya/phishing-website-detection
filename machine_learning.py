...
for i in range(0, K):
    ...
    tn, fp, fn, tp = confusion_matrix(
        y_true=Y_test_list[i], y_pred=rf_predictions).ravel()
    ...
    tn, fp, fn, tp = confusion_matrix(
        y_true=Y_test_list[i], y_pred=dt_predictions).ravel()
    ...
    tn, fp, fn, tp = confusion_matrix(
        y_true=Y_test_list[i], y_pred=svm_predictions).ravel()
    svm_accuracy, svm_precision, svm_recall = calculate_measures(
        tn, tp, fn, fp)
    ...
    tn, fp, fn, tp = confusion_matrix(
        y_true=Y_test_list[i], y_pred=ab_predictions).ravel()
    ...
    tn, fp, fn, tp = confusion_matrix(
        y_true=Y_test_list[i], y_pred=nb_predictions).ravel()
    ...
    tn, fp, fn, tp = confusion_matrix(
        y_true=Y_test_list[i], y_pred=nn_predictions).ravel()
    ...
    tn, fp, fn, tp = confusion_matrix(
        y_true=Y_test_list[i], y_pred=kn_predictions).ravel()
